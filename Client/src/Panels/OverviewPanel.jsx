...
export const OverviewPanel = ({ student, stats, activities }) => {
   return (
       <div>
          ...
          <span
              className="inline-flex items-center gap-1.5 bg-white/15 backdrop-blur border border-white/20 text-white text-xs font-medium px-3 py-1.5 rounded-full">
                   ...
                   <div className="space-y-3">
                       {[
                           ...
                           <div key={i} className="flex items-center gap-3">
                               ...
                               <span
                                   className={`text-xs font-semibold ${item.pct === 100 ? 'text-green-600' : 'text-orange-500'}`}>{item.status}</span>
                           </div>
                       ))}
                   </div>
               </div>
